...
<div class="card">
    ...
    <div class="card-header">
        <h5 class="card-title mb-0">Nhóm đối tượng</h5>
    </div>

    <div class="card-body">

        <form action="{{ route('stakeholder.index') }}">
            <div class="row">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('stakeholder.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="title" name="title" placeholder="Tên lĩnh vực *" required="" autofocus="" value="{{ !empty($stakeholder->title) ? $stakeholder->title : old('title') }}">
                    </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex flex-row justify-content-between align-items-center">
                    ...
                    <input type="hidden" id="url" value="{{ route('stakeholder.delete') }}" >
                </div>
            </div>
            <div class="card-body">
                ...
                <table class="table table-hover table-vcenter table-bordered table-striped" id="datatable" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('stakeholder.index', ['id' => $val->id]) }}">{{ $val->title ?? null }}</a>
                            </td>
                        </tr>
                        @endforeach
                        @endif
