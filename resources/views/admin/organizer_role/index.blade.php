...
<div class="card">
    <div class="card-header">
        <h5 class="card-title mb-0">Danh sách Nhóm quyền Ban tổ chức</h5>
    </div>
    <div class="card-body">
...
<div class="card">
    <div class="card-header">
        <div class="d-flex flex-row justify-content-between align-items-center">
            <a class="btn btn-sm btn-secondary" href="{{ route('organizer.role.create') }}">Thêm nhóm quyền&nbsp;&nbsp;<i class="ti ti-circle-plus"></i></a>
            <a class="btn btn-sm btn-outline-danger btn_del_multi" href="javascript:;"><i class="ti ti-trash"></i>&nbsp;&nbsp;Xóa</a>
            <input type="hidden" id="url" value="{{ route('organizer.role.delete') }}" >
        </div>
    </div>
    <div class="card-body">
                ...
                <tbody>
                    @if(!empty($data) && count($data) > 0) 
                        ...
                        <tr>
                            ...
                            <td>
                                {{ vdh_label_button(route('organizer.role.create', ['id' => $val->id]), route('organizer.role.delete', ['id' => $val->id])) }}
                            </td>
                        </tr>
                        @endforeach
                    @endif
